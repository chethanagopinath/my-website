  ...
  return (
    <div classname="main-div">
      <div classname="sub-div">
        ...
        <p>I have both academic and industry experience in CS of about 8 years in Computer Science in both software development and testing. My skills include Ruby, Rails, Python, Java, Javascript, HTML, CSS, MySQL and Git. I have also had industry experience in automated testing at Wolters Kluwer ELM Solutions. I've worked with clients like Walmart, JPMorgan Chase, Nissan and NCR.
        </p>
