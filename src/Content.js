...
export default function Content(){
  return(
      <div className="sub-div">
        ...
        <p>
        Being a budding open-source contributor, I spend my weekends working on beginner-friendly issues in shf-project from AgileVentures, ifme project and other repositories on GitHub which allow me to build up the confidence to contribute more - waiting eagerly for <a className = "links" href="https://hacktoberfest.digitalocean.com/"> Hacktoberfest</a>!
        </p>
        <p>
        I am a member of <a className = "links" href = "https://linktr.ee/breakingbarriers">Breaking Barriers in Tech</a>, a nurturing and inclusive community which aims to combat obstacles faced by minorities in tech. We are building a strong unified community through informative workshops, fun events and such. I am also a registered mentor at the mentorship program at <a className = "links" href = "https://www.lotusstemm.org/">LotusSTEMM</a>, an organization that is working to provide a networking and leadership platform for South Asian women in Science, Technology, Engineering, Math and Medicine. 
        </p>
        <p>
        During my free time, I work on cool side projects to solve problems that I face every day. Currently, I am working on building a Chrome extension called TinyNotes, which is a basic note-taking app that would stay on my new tab window built using Javascript, HTML and CSS. I have also recently joined as a volunteer at <a className = "links" href = "https://www.womenwhocode.com/python">Women Who Code Python track</a> to help with slack channel moderation and event co-ordination. I try to add value to young, aspiring software engineers such as myself by writing out tiny technical posts at <a className = "links" href="https://dev.to/">dev.to</a>.
        </p>
        <p>
